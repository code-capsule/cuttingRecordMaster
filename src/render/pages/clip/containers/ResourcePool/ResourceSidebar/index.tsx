...
import { ReactComponent as IcCommonAudioSvg } from '@common/svgs/ic_common_audio.svg';
...
const ResourceSidebar = () => {
  ...
  return (
    <div className="clip-resource-sidebar">
      <div className="clip-resource-item" />
      <div
      ...
      <div
        className={`clip-resource-item ${resourceContextReducer.sidebarType === EResourceType.audio ? 'active' : ''}`}
        onClick={() => resourceContextReducer?.updateSidebarType?.(EResourceType.audio)}
      >
        <IcCommonAudioSvg className="resource-svg" />
      </div>
      <div
