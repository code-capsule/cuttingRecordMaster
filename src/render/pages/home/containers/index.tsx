...
const DRAFT_LIST: MasterDraftType.IDraftItem[] = [
  {
    ...
    videoUrl: 'https://player.vimeo.com/external/436572488.sd.mp4?s=eae5fb490e214deb9ff532dd98d101efe94e7a8b&profile_id=139&oauth2_token_id=57447761',
    duration: 351,
  ...
  },
  {
    ...
    videoUrl: 'https://player.vimeo.com/external/436553499.sd.mp4?s=0e44527f269278743db448761e35c5e39cfaa52c&profile_id=139&oauth2_token_id=57447761',
    duration: 351,
    createTime: 1687943237882,
    updateTime: 1687943237882,
  },
  {
    ...
    videoUrl: 'https://player.vimeo.com/external/361861493.sd.mp4?s=19d8275ca755d653042a87ef28b2f0b2eabf57d0&profile_id=139&oauth2_token_id=57447761',
    duration: 351,
    createTime: 1687943237882,
    updateTime: 1687943237882,
  },
    ...
    <div className="home-container">
      ...
      <div className="home-right">
        <Scrollbar maxHeight={window.innerHeight - 32} x={{ show: false }} y={{ show: false }}>
          <CuttingRecordingBox />
          <div className="home-product-title">最近作品 </div>
